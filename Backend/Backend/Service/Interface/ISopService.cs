...
namespace Backend.Service.Interface
{
    public interface ISopService
    {
        ...
        public Task<ApiResponse<List<SopDto>>> GetAllSops(string search, string status, int page, int pageSize, bool isFavourite, string soryBy, string sortOrder);
        ...
        public Task<string> GenerateAiSop(string description);
